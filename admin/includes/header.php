...
<head>
    ...
    <title>Integracion Tienda Online</title>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="http://localhost/card/">
                    <i class="fas fa-backward"></i>
                    <span>Ir a tienda</span></a>
            </li>
                                        ...
                                        <div class="container" id="felo">
                                            <form class="" action="updateperfil.php" method="POST">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="user" id="user" value="<?php echo $_SESSION['nombre']?>" disabled>
                                                </div>
                                                <div class="form-group">
