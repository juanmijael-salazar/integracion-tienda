...
<body>
    ...
    <header class="py-1" style="background-color:#3472D8;">
        <div class="container px-2 px-lg-2 my-2">
            <div class="text-center text-white">
                <h1 class="display-4 fw-bolder">Tienda Online</h1>
                <p class="lead fw-normal text-white-50 mb-0">- Catálogo de productos -</p>
    ...
    <br>
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container-fluid" style="width:98%;font-size:20px;">
                <a class="navbar-brand" href="#">Integración Catálogo Tienda</a>
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav" >
                        <ul class="navbar-nav text-info">
                            <a href="#" class="nav-link" id="arriba" category="all" style="font-size:20px;border-left: 1px solid #757575;">Todo</a>
                            <?php
    ...
    <!-- Footer-->
    <footer class="py-3" style="background-color:#3472D8;">
